...
export default function GovernmentLevels() {
  return (
    <div style={{ background: '#fff', minHeight: '100vh', padding: '40px 20px 60px' }}>
      <div style={{ maxWidth: '980px', margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          <p style={{ fontSize: '13px', fontWeight: 600, letterSpacing: '1.5px', textTransform: 'uppercase', color: '#555', marginBottom: '4px', fontFamily: 'Arial, sans-serif' }}>
            Levels of Government in &nbsp;/&nbsp; Niveaux de gouvernement à
          </p>
          <h1 style={{ fontSize: '44px', fontWeight: 900, letterSpacing: '3px', color: '#111', fontFamily: 'Arial, sans-serif' }}>
            MONCTON
          </h1>
        </div>
